...
import graphviz
from dtreeviz.model_interpretation import prediction_path_interpretation as prediction_path
...
def ctreeviz_leaf_samples(tree_model: tree.DecisionTreeClassifier,
    ...
    if display_type == "plot":
        ...
        ax.legend([bar_container0, bar_container1],
                  [f'class {tree_model.classes_[0]}', f'class {tree_model.classes_[1]}'])
    elif display_type == "text":
