...
def xgb_booster() -> xgb.Booster:
    return joblib.load("fixtures/xgb_model")


@pytest.fixture()
def xgb_tree(dataset, xgb_booster) -> XGBDTree:
...
def test_get_node_samples(xgb_tree, dataset):
    node_samples = xgb_tree.get_node_samples(dataset)
