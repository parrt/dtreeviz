...
from dtreeviz.models.sklearn_decision_trees import (
    ShadowSKDTree,
...
def test_x_dataset(x_dataset_classifier):
    ...
    assert n_cols == 16, "Number of columns shoud be 6"
...
def test_is_classifier(shadow_dec_tree):
    assert shadow_dec_tree.is_classifier()
